...
with(raw_data, {
  ...
  plot(raw_data$datetime, raw_data$Sub_metering_1, 
       type = "l", 
       ylab = "Energy sub metering",
       xlab="")
  lines(raw_data$datetime, raw_data$Sub_metering_2, col = "red")
  lines(raw_data$datetime, raw_data$Sub_metering_3, col = "blue")
  legend("topright", col = c("black", "blue", "red"), bg=NULL,box.lwd = 0, legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=c(1,1,1))
